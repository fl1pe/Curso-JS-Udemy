/* 
Javascriptébaseado em protótipos para passar propriedades e métodos
...
Todos os objetos tem uma referência interna para um protótipo(proto_)
...
// Instância
const pessoa1 = new Pessoa("Felipe", "Bezerra"); // Pessoa => Função construtora
const pessoa2 = new Pessoa("Felipe", "Sousa"); // Pessoa => Função construtora
